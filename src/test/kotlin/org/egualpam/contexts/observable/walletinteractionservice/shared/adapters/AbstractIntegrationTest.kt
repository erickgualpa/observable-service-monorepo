...
import org.egualpam.contexts.observable.walletinteractionservice.e2e.helper.AccountTestRepository
import org.egualpam.contexts.observable.walletinteractionservice.e2e.helper.DepositTestRepository
import org.egualpam.contexts.observable.walletinteractionservice.e2e.helper.OwnerTestRepository
import org.egualpam.contexts.observable.walletinteractionservice.e2e.helper.WalletTestRepository
...
abstract class AbstractIntegrationTest {
  ...
  companion object {
    ...
    private val containers = ComposeContainer(File("docker-compose-test.yml"))
